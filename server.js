...
const blackCards = ["No te puedo explcar el asco que me da ________.","Trágico accidente deja 35 heridos. La causa:________.","La causa de la Tercera Guerra Mundial va a ser ________.",
    ...
    "En el nombre del Padre, del Hijo de ________.","-¿Por qué llora Quico? -Por ________.","Mi pareja me dejó por ________.", "Cada vez hay más gente con fobia a ________.",
...
const whiteCards = ["Un Volquete lleno de cadáveres", "Un bebé de caca", "El olor a billete viejo", 
    ...
    "El acoso sexual en el subte","Fosas comunes","El gluten","Mi hermano","La versión braille del Kamasutra","Algún pelotudo de la farándula al azar",
